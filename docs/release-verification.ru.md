...
```powershell
Get-FileHash .\pact-mission-control-0.1.8-win-x64.zip -Algorithm SHA256
...
```powershell
gh attestation verify .\pact-mission-control-0.1.8-win-x64.zip --repo s-titov-82/pact-mission-control
```
