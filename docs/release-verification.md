...
```powershell
Get-FileHash .\pact-mission-control-0.1.6-win-x64.zip -Algorithm SHA256
Get-FileHash .\pact-mission-control-0.1.6-win-x64-setup.exe -Algorithm SHA256
...
```powershell
gh attestation verify .\pact-mission-control-0.1.6-win-x64.zip --repo s-titov-82/pact-mission-control
```
